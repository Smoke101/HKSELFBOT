...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย Ħ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ꝁ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠ S͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ɇ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ł͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠F͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ƀ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ø͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ŧ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
╠       Ħ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ꝁ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠ S͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ɇ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ł͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠F͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ƀ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ø͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ŧ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠
╚══════════════┛""",
    "userAgent": [
...
╠❋►ตัส;
╠❋►Spam on ↔ off
╰═❋BY:Ħ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ꝁ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠ S͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ɇ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ł͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠F͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ƀ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ø͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠Ŧ͙͕͙͙͕͙͠҉͙͕͙͙͕͙͠"""
    return helpSet
